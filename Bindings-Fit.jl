...
begin
    ...
    #patched_comp_model.c1.index1 = 3
    ...
    patched_comp_model.m2.model.column = 1.7 
    patched_comp_model.m2.model.rlogxi = 3.5
    #patched_comp_model.m2.model.Cabund = 1
    #patched_comp_model.m2.model.Nabund = 1
    #patched_comp_model.m2.model.Oabund = 1
    #patched_comp_model.m2.model.Fabund = 1
    #patched_comp_model.m2.model.Neabund = 1
    #patched_comp_model.m2.model.Naabund = 1
    #patched_comp_model.m2.model.Mgabund = 1
    #patched_comp_model.m2.model.Alabund = 1
    #patched_comp_model.m2.model.Siabund = 1
    #patched_comp_model.m2.model.Pabund = 1
    #patched_comp_model.m2.model.Sabund = 1
    #patched_comp_model.m2.model.Clabund = 1
    #patched_comp_model.m2.model.Arabund = 1
    #patched_comp_model.m2.model.Kabund = 1
    #patched_comp_model.m2.model.Caabund = 1
    #patched_comp_model.m2.model.Scabund = 1
    #patched_comp_model.m2.model.Tiabund = 1
    #patched_comp_model.m2.model.Vabund = 1
    #patched_comp_model.m2.model.Crabund = 1
    #patched_comp_model.m2.model.Mnabund = 1
    patched_comp_model.m2.model.Feabund = 2
    #patched_comp_model.m2.model.Coabund = 1
    #patched_comp_model.m2.model.Niabund = 1
    #patched_comp_model.m2.model.Cuabund = 1
    #patched_comp_model.m2.model.Znabund = 1
    #patched_comp_model.m2.model.write_outfile = 0
    #patched_comp_model.m2.model.outfile_idx = 0
    ...
    #patched_comp_model.a2.Γ = 2 
    patched_comp_model.a2.A_Fe = 2
    #patched_comp_model.a2.density = 17
    patched_comp_model.a2.inclination = 60

    #patched_comp_model.a3.K = 1
    #patched_comp_model.a3.a =2

    bind!(prob, (1, :c1, :index1) => (1, :c1, :index2) => (1, :c2, :index1) => (1, :c2, :index2))
    bind!(prob, (1, :a1, :Γ) => (1, :a2, :Γ) => (1, :a3, :a))
    ...
    bind!(prob, (1, :a1, :A_Fe) => (1, :m2, :Feabund) =>(1, :a2, :A_Fe))
...
begin
    ...
    patched_comp_model.model.m2.column.frozen = false
    patched_comp_model.model.m2.rlogxi.frozen = false
...
begin 
    result = fit(prob, LevenbergMarquadt(), verbose = true)#, max_iter = 100000)
    ApplyResult(patched_comp_model,result)
#plot the results 
end
